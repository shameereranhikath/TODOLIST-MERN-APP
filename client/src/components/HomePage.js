        ...
        <div class='mt-16 lg:mb-24 max-w-md'>
          <div class='max-w-2xl lg:max-w-md mb-6'>
            ...
            <p class='text-lg text-gray-200 leading-loose'>
              ...
              This project was built  traditional redux concepts. This project will
              teach you everything you need to know about redux,mongoose Schema,Professional MVC Project Structure for API ,creating API and Best practices in the React
            </p>
          </div>
